...
<div className="grid grid-cols-2 gap-2 py-4">
  <img src="/images/page/16_pengumumanberanda.png" alt="Pengumuman di Beranda" className="w-full max-w-xs mx-auto" />
  <img src="/images/page/17_pengumuman.png" alt="Detail Pengumuman" className="w-full max-w-xs mx-auto" />
</div>   
