...
<div className="grid grid-cols-3 gap-2 py-4">
  <img src="/images/page/02_login.jpg" alt="Tampilan 1" className="rounded-xl shadow-md w-full" />
  <img src="/images/page/03_loginwali.jpg" alt="Tampilan 2" className="rounded-xl shadow-md w-full" />
  <img src="/images/page/04_loginsiswa.jpg" alt="Tampilan 3" className="rounded-xl shadow-md w-full" />
</div>   
...
* [**Lupa Password?**](broken-reference)\
