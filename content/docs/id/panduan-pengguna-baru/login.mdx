...
<div className="grid grid-cols-3 gap-2 py-4">
  <img src="/images/page/02_login.jpg" alt="Login 1" className="w-full max-w-[280px] mx-auto" />
  <img src="/images/page/03_loginwali.jpg" alt="Login 2" className="w-full max-w-[280px] mx-auto" />
  <img src="/images/page/04_loginsiswa.jpg" alt="Login 3" className="w-full max-w-[280px] mx-auto" />
</div>   
