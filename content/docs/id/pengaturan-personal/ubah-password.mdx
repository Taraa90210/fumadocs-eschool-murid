...
<div className="grid grid-cols-2 gap-2 py-4">
  <img src="/images/page/43_setpw.png" alt="Tampilan 1" className="w-full max-w-xs mx-auto" />
  <img src="/images/page/44_setpwconf.png" alt="Tampilan 2" className="w-full max-w-xs mx-auto" />
</div>
